...
#支持系统
perl -p -i -e "s/IOS:11-14/IOS:11-14/g"  cydia副本 sileo副本.json
perl -p -i -e "s/1.0.0/0.9.6b/g"  cydia副本 sileo副本.json
#更新时间
perl -p -i -e "s/2021-04-10/2021-04-10/g"  sileo副本.json
perl -p -i -e "s/暂时没有历史版本/2021-04-04更新支持A12/g"  cydia副本
#截图
